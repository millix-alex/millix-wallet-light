...
const WalletCreatePasswordView = (props) => {
    ...
    return (
        <div className={"wallet-create-password"}>
            <Row>
                {props.walletImport ? (
                                        <Col className={'center mb-3'}>type the password to unlock
                                            your wallet. if you do not know the password to unlock
                                            the wallet you have lost access to your funds.</Col>) :
                 (<Col className={'center mb-3'}>create a strong password and
                     save it in a safe place. if you lose or forget your
                     password you will lose your funds.</Col>)}
            </Row>
            <Row>
