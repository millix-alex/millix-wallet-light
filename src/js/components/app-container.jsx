...
import MessageNewView from './message-send-view';
import MessageReceivedView from './message-received-list-view';
import MessageSentView from './message-sent-list-view';
