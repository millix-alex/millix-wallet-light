...
export const SET_LOG_SIZE                  = 'SET_LOG_SIZE';
...
export const ADD_STORE_CONFIG              = 'ADD_STORE_CONFIG';
...
export const UPDATE_CURRENCY_PAIR_SUMMARY  = 'UPDATE_CURRENCY_PAIR_SUMMARY';
export const UPDATE_WALLET_NOTIFICATION    = 'UPDATE_WALLET_NOTIFICATION';
export const UPDATE_NODE_ATTRIBUTE         = 'UPDATE_NODE_ATTRIBUTE';
export const UPDATE_NOTIFICATION_VOLUME    = 'UPDATE_NOTIFICATION_VOLUME';
export const UPDATE_MESSAGE_STAT           = 'UPDATE_MESSAGE_STAT';
